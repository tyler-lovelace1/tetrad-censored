        ...
        for(int i = 0; i < q; i++){
            for(int j = 0; j < l[i]; j++){
                ...
                if(curCol.zSum() == 0) {
                    ...
                    for(int k = 0; k < yDat.rows();k++) {
                        cats.put((int)yDat.get(k,i),0);
                    }
                    for(int k = 0; k < yDat.rows();k++) {
                        cats.put((int)yDat.get(k,i),cats.get((int)yDat.get(k,i))+1);
                    }
                    throw new IllegalArgumentException("Discrete data is missing a level: variable " + variables.get(p + i) + ": " + cats + " level " + (j+1));
                }
...
//        System.out.println("alpha1: " + par.alpha1);
//        System.out.println("alpha2: " + par.alpha2);
//        System.out.println("betad: " + par.betad);
//        System.out.println("beta: " + par.beta);
//        System.out.println("theta: " + par.theta);
...
//        System.out.println("alpha1: " + gradOut.alpha1);
//        System.out.println("alpha2: " + gradOut.alpha2);
//        System.out.println("betad: " + gradOut.betad);
//        System.out.println("beta: " + gradOut.beta);
//        System.out.println("theta: " + gradOut.theta);
//        System.out.println("phi: " + gradOut.phi);


//        System.out.println("Loss: " + (sqloss + catloss)/((double) n));
