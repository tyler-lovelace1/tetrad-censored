...
//        logisticRegression.setRows(_rows);
        ...
        for (Node _x : variablesPerNode.get(x)) {
            ...
            LogisticRegression.Result result0 = logisticRegression.regress((DiscreteVariable) _x, regressors0, _rows);
            ...
            LogisticRegression.Result result1 = logisticRegression.regress((DiscreteVariable) _x, regressors1, _rows);
