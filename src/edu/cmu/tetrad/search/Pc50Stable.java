 ...
 */
public final class Pc50Stable implements GraphSearch {
     ...
     */
    public Pc50Stable(IndependenceTest independenceTest) {
...
//        System.out.println("ForkJoin FAS:");
    ...
    public Graph search(IFas fas, List<Node> nodes) {
        System.out.println("Running PC50 algorithm");
        this.logger.log("info", "Starting PC50 algorithm");
...
//            orientUnshieldedTriplesConcurrent(knowledge, getIndependenceTest(), getMaxIndegree());
        orientUnshieldedTriples(sepsets50, knowledge);
        ...
        System.out.println("PC50 Elapsed time = " + (elapsedTime) / 1000. + " s");

        TetradLogger.getInstance().log("info", "Elapsed time = " + (elapsedTime) / 1000. + " s");
        TetradLogger.getInstance().log("info", "Finishing PC50 algorithm.");
...
//    }
    ...
    private boolean colliderAllowed(Node x, Node y, Node z, IKnowledge knowledge) {
        return Pc50Stable.isArrowpointAllowed1(x, y, knowledge) &&
                Pc50Stable.isArrowpointAllowed1(z, y, knowledge);
    }
