...
//    int getMultiplier(int caseNumber);
    ...
    /**
     * @return the censoring data matrix as a TetradMatrix.
     * @throws IllegalStateException if this is not a censored data set.
     */
    TetradMatrix getDoubleCensorData();
...
//    boolean isMulipliersCollapsed();
    ...
    /**
     * @return true if this is a censored data set--that is, if it contains at
     * least one censored variable.
     */
    boolean isCensored();
