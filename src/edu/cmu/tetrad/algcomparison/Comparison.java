...
//                out.println();
    ...
    public void configuration(String path) {
        try {
            ...
            algorithms.addAll(reflections.getSubTypesOf(Algorithm.class));

            statistics.addAll(reflections.getSubTypesOf(Statistic.class));

            independenceWrappers.addAll(reflections.getSubTypesOf(IndependenceWrapper.class));

            scoreWrappers.addAll(reflections.getSubTypesOf(ScoreWrapper.class));

            simulations.addAll(reflections.getSubTypesOf(Simulation.class));
